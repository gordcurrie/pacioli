...
- [ ] **3. editTransactionFXForm / transactionFXCell duplicate fetch** (`handler/transaction.go:260-302`)
...
- [ ] **4. createSecurity renders error form 3x with same struct literal** (`handler/security.go:273-305`)
...
- [ ] **5. PRAGMA busy_timeout set twice** (`sqlite/db.go:34,41`)
...
- [ ] **7. questradePreview renderErr closure** (`handler/questrade.go:269-279`)
...
- [ ] **11. NGSvc optional nil-check** (`handler/handler.go:229-232`)
